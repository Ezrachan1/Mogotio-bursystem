...
# Email Configuration
# In DEBUG mode: emails print to your terminal (no SMTP needed)
# In production: uses real SMTP (Office365/Outlook)
if DEBUG:
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@constituency.go.ke')
